...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8" style={{ background: 'linear-gradient(135deg, #A346BD 0%, #7C3AED 100%)' }}>
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="text-white">
              <div className="text-4xl font-bold mb-2">100K+</div>
              <div className="text-purple-100">{language === "ar" ? "طالب نشط" : "Active Learners"}</div>
            </div>
            <div className="text-white">
              <div className="text-4xl font-bold mb-2">50+</div>
              <div className="text-purple-100">{language === "ar" ? "دورة احترافية" : "Expert Courses"}</div>
            </div>
            <div className="text-white">
              <div className="text-4xl font-bold mb-2">4.9</div>
              <div className="text-purple-100">{language === "ar" ? "تقييم المستخدمين" : "User Rating"}</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">
              {language === "ar" ? "لماذا تختار أكاديمية برايم؟" : "Why Choose Academy Prime?"}
            </h2>
            <p className="text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
              {language === "ar" 
                ? "نحن نقدم تعليماً عالي الجودة في العملات الرقمية مع خبراء من الصناعة ومحتوى محدث باستمرار."
                : "We provide high-quality crypto education with industry experts and constantly updated content."}
            </p>
          </div>
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center p-6 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
              <div className="w-12 h-12 mx-auto mb-4 rounded-full flex items-center justify-center" style={{ backgroundColor: '#E9D5FF' }}>
                <svg className="w-6 h-6" style={{ color: '#A346BD' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </div>
              <h3 className="font-semibold text-slate-900 dark:text-white mb-2">
                {language === "ar" ? "محتوى احترافي" : "Expert Content"}
              </h3>
              <p className="text-sm text-slate-600 dark:text-slate-400">
                {language === "ar" ? "دورات من خبراء الصناعة" : "Courses from industry experts"}
              </p>
            </div>
            <div className="text-center p-6 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
              <div className="w-12 h-12 mx-auto mb-4 rounded-full flex items-center justify-center" style={{ backgroundColor: '#E9D5FF' }}>
              ...
              <h3 className="font-semibold text-slate-900 dark:text-white mb-2">
                {language === "ar" ? "تحديثات مستمرة" : "Constant Updates"}
              </h3>
              <p className="text-sm text-slate-600 dark:text-slate-400">
                {language === "ar" ? "محتوى محدث بانتظام" : "Regularly updated content"}
              </p>
            </div>
            <div className="text-center p-6 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
              <div className="w-12 h-12 mx-auto mb-4 rounded-full flex items-center justify-center" style={{ backgroundColor: '#E9D5FF' }}>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">
                {language === "ar" ? "تواصل مع المتعلمين" : "Connect with learners"}
              </p>
            </div>
            <div className="text-center p-6 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
              <div className="w-12 h-12 mx-auto mb-4 rounded-full flex items-center justify-center" style={{ backgroundColor: '#E9D5FF' }}>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">
                {language === "ar" ? "احصل على شهادات إتمام" : "Get completion certificates"}
              </p>
            </div>
          </div>
        </div>
